...
SOUL_NUCLEUS_AFFINITIES: Final[tuple[NucleusAffinity, ...]] = (
    NucleusAffinity(
        ...
        ("ConnectedRuntime", "DecisionTrace", "GovernanceBackend", "SoulETROmegaSystem"),
        "gateway-mediated",
    ...
    NucleusAffinity(
        ...
        ("QuantumCrawler", "TransystemSARA", "DecisionTrace", "ProvenanceTracker", "DeviceAdapter", "HabitLearningEngine", "AnticipationEngine"),
