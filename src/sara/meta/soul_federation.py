...
SOUL_NUCLEUS_AFFINITIES: Final[tuple[NucleusAffinity, ...]] = (
    ...
    NucleusAffinity(
        ...
        ("ARA_Extended", "ETR_Extended", "ITR_Extended", "ETR_AnalysisNucleus", "ETR_RealityFilterNucleus"),
        "context-enrichment",
    ...
    NucleusAffinity(
        ...
        ("ARA_Extended", "ETR_Extended", "SafeSandbox", "ETR_EntropyNucleus", "ETR_AsymmetryNucleus"),
        "content-validation",
    ...
    NucleusAffinity(
        ...
        ("ARA_Extended", "ETR_Extended", "LegalAI", "ProvenanceTracker", "ETR_PrioritizationNucleus", "ETR_SymbiosisHostNucleus"),
        "artifact-governance",
