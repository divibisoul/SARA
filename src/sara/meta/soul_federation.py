...
SARA_OPERATIONS: Final[dict[str, dict]] = {
    ...
    "sara.hortacore.assess": {
        ...
        "purpose": "executar a avaliação meta existente do AeternumChimeraBridge/HortaCore sem duplicar governança ou ERU",
        "requires_auth": True,
    },
    "sara.state": {
        "version": "1.0.0",
...
SOUL_NUCLEUS_AFFINITIES: Final[tuple[NucleusAffinity, ...]] = (
    NucleusAffinity(
        ...
        ("ConnectedRuntime", "DecisionTrace", "GovernanceBackend", "SoulETROmegaSystem", "AeternumChimeraBridge"),
        "gateway-mediated",
    ...
    NucleusAffinity(
        ...
        ("sara.audit", "sara.cycle", "sara.regenerate", "sara.trace", "sara.hortacore.assess"),
        ("ARA_Extended", "ETR_Extended", "ITR_Extended", "ETR_AnalysisNucleus", "ETR_RealityFilterNucleus", "AeternumChimeraBridge"),
        "context-enrichment",
    ...
    NucleusAffinity(
        ...
        ("sara.audit", "sara.regenerate", "sara.trace", "sara.hortacore.assess"),
        ("ARA_Extended", "ETR_Extended", "SafeSandbox", "ETR_EntropyNucleus", "ETR_AsymmetryNucleus", "AeternumChimeraBridge"),
        "content-validation",
    ...
    NucleusAffinity(
        ...
        ("sara.audit", "sara.regenerate", "sara.cycle", "sara.trace", "sara.hortacore.assess"),
        ("ARA_Extended", "ETR_Extended", "LegalAI", "ProvenanceTracker", "ETR_PrioritizationNucleus", "ETR_SymbiosisHostNucleus", "AeternumChimeraBridge"),
        "artifact-governance",
    ...
    NucleusAffinity(
        ...
        ("TrinityERUUnified", "ConnectedRuntime", "CycleAuditor", "ETR_ReverseExecutionNucleus", "ETR_NeuralAdaptiveDirector"),
    ...
    NucleusAffinity(
        ...
        ("QuantumCrawler", "TransystemSARA", "DecisionTrace", "ProvenanceTracker", "DeviceAdapter", "HabitLearningEngine", "AnticipationEngine", "AeternumChimeraBridge"),
    ...
    NucleusAffinity(
        ...
        ("ERU_Engine", "GovernedSARA", "DecisionTrace", "ProvenanceTracker", "SoulETROmegaSystem", "MicroMacroManager"),
