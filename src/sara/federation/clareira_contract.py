"""Native SARA copy of the Clareira federation contract.
The repository-level shared/ contract remains the federation reference; this
module keeps the installed sara package self-contained at runtime.
"""
...
def packet_to_dict(packet: ClareiraPacket) -> dict[str, Any]:
    return {
        "id": packet.id,
        "data": packet.data,
        "informationalValue": packet.informational_value,
        "criticality": packet.criticality,
        "packetType": packet.packet_type,
        "sourceId": packet.source_id,
        "destinationHint": packet.destination_hint,
...
def make_clareira_packet(
    ...
    *,
    ...
    informational_value: float = 10.0,
    ...
    return ClareiraPacket(
        ...
        data=data,
        informational_value=float(informational_value),
