...
from sara.meta.aeternum_modules import AeternumModuleAdapter
...
def build_default_system(*, fail_closed: bool = True) -> SaraSystem:
    ...
    aeternum_modules = AeternumModuleAdapter(registry)
    ...
    candidates = [
        ...
        aeternum_chimera, omega, aeternum_modules,
    ]
    ...
    return SaraSystem(
        ...
        components={
            ...
            "omega": omega,
            "aeternum_modules": aeternum_modules,
        },
    )
